...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.3/render"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./anchor', {hash: 1014568902, creator: function (require, exports) {
"use strict";
...
ims.set('./attributes', {hash: 1262494723, creator: function (require, exports) {
"use strict";
...
/*bundle*/const attributes = new Attributes();
exports.attributes = attributes;
}});
...
ims.set('./instances/index', {hash: 2022060609, creator: function (require, exports) {
"use strict";
...
ims.set('./instances/node', {hash: 3167083658, creator: function (require, exports) {
"use strict";
...
ims.set('./prerendered/index', {hash: 483738484, creator: function (require, exports) {
"use strict";
...
/*bundle*/const prerender = new class {
  #ssr = [];
  get ssr() {
    return this.#ssr;
  }
...
ims.set('./widget/attributes', {hash: 1029410984, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/checksum', {hash: 1702419318, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/csr', {hash: 1023760945, creator: function (require, exports) {
"use strict";
...
var _core = require("@beyond-js/kernel/core");
/*bundle*/class WidgetCSR extends _core.Events {
  #widget;
  #bundle;
  get bundle() {
    return this.#bundle;
...
ims.set('./widget/index', {hash: 2251972216, creator: function (require, exports) {
"use strict";
...
/*bundle*/class BeyondWidget extends Element {
  #specs;
  get specs() {
    return this.#specs;
  }
...
ims.set('./widget/renderer', {hash: 571206461, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/sr', {hash: 2731121275, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/ssr', {hash: 2834037449, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/styles/global', {hash: 1566285625, creator: function (require, exports) {
"use strict";
...
var _core = require("@beyond-js/kernel/core");
/*bundle*/class GlobalCSS extends _core.Events {
  #widget;
  #version = 0;
  constructor(widget) {
    super();
...
ims.set('./widget/styles/index', {hash: 1538919774, creator: function (require, exports) {
"use strict";
...
ims.set('./widget/styles/link', {hash: 3219871066, creator: function (require, exports) {
"use strict";
...
ims.set('./widgets', {hash: 3986250608, creator: function (require, exports) {
"use strict";
...
/*bundle*/const widgets = new BeyondWidgets();
exports.widgets = widgets;
}});

__pkg.exports.descriptor = [{"im":"./attributes","from":"attributes","name":"attributes"},{"im":"./instances/node","from":"NodeWidget","name":"NodeWidget"},{"im":"./prerendered/index","from":"prerender","name":"prerender"},{"im":"./widget/csr","from":"IBeyondWidgetController","name":"IBeyondWidgetController"},{"im":"./widget/csr","from":"WidgetCSR","name":"WidgetCSR"},{"im":"./widget/index","from":"IWidgetSpecs","name":"IWidgetSpecs"},{"im":"./widget/index","from":"BeyondWidget","name":"BeyondWidget"},{"im":"./widget/styles/global","from":"GlobalCSS","name":"GlobalCSS"},{"im":"./widget/styles/index","from":"StylesManager","name":"StylesManager"},{"im":"./widgets","from":"widgets","name":"widgets"}];

export let attributes, NodeWidget, prerender, IBeyondWidgetController, WidgetCSR, IWidgetSpecs, BeyondWidget, GlobalCSS, StylesManager, widgets;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'attributes') && (attributes = require ? require('./attributes').attributes : value);
    (require || prop === 'NodeWidget') && (NodeWidget = require ? require('./instances/node').NodeWidget : value);
    (require || prop === 'prerender') && (prerender = require ? require('./prerendered/index').prerender : value);
    (require || prop === 'IBeyondWidgetController') && (IBeyondWidgetController = require ? require('./widget/csr').IBeyondWidgetController : value);
    (require || prop === 'WidgetCSR') && (WidgetCSR = require ? require('./widget/csr').WidgetCSR : value);
    (require || prop === 'IWidgetSpecs') && (IWidgetSpecs = require ? require('./widget/index').IWidgetSpecs : value);
    (require || prop === 'BeyondWidget') && (BeyondWidget = require ? require('./widget/index').BeyondWidget : value);
    (require || prop === 'GlobalCSS') && (GlobalCSS = require ? require('./widget/styles/global').GlobalCSS : value);
    (require || prop === 'StylesManager') && (StylesManager = require ? require('./widget/styles/index').StylesManager : value);
...
//# sourceMappingURL=render.browser.mjs.map