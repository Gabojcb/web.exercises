...
exports.instances = exports.brequire = exports.bimport = exports.Package = exports.Module = exports.ListenerFunction = exports.IMSpecs = exports.IMCreators = exports.IExportsDescriptor = exports.IBundleSpecs = exports.Events = exports.Bundle = void 0;
let __pkg = {
  exports: {}
};
const ims = new Map();
...
// Module exports
exports.Package = Package;
exports.IMCreators = IMCreators;
exports.IMSpecs = IMSpecs;
exports.IExportsDescriptor = IExportsDescriptor;
exports.Module = Module;
exports.instances = instances;
exports.ListenerFunction = ListenerFunction;
exports.Events = Events;
exports.Bundle = Bundle;
exports.IBundleSpecs = IBundleSpecs;
exports.brequire = brequire;
exports.bimport = bimport;
__pkg.exports.process = function (require) {
  exports.bimport = bimport = require('./bimport/bimport').bimport;
  exports.brequire = brequire = require('./bimport/brequire').brequire;
  exports.IBundleSpecs = IBundleSpecs = require('./bundle').IBundleSpecs;
  exports.Bundle = Bundle = require('./bundle').Bundle;
  exports.Events = Events = require('./events/index').Events;
  exports.ListenerFunction = ListenerFunction = require('./events/types').ListenerFunction;
  exports.instances = instances = require('./instances').instances;
  exports.Module = Module = require('./module/index').Module;
  exports.IExportsDescriptor = IExportsDescriptor = require('./package/exports').IExportsDescriptor;
  exports.IMSpecs = IMSpecs = require('./package/ims/im').IMSpecs;
  exports.IMCreators = IMCreators = require('./package/ims/index').IMCreators;
  exports.Package = Package = require('./package/index').Package;
};
const __bp = {};
