...
__pkg.exports.process = function ({
  ...
  (require || prop === 'DependenciesStyles') && (exports.DependenciesStyles = DependenciesStyles = require ? require('./dependencies-styles').DependenciesStyles : value);
  (require || prop === 'styles') && (exports.styles = styles = require ? require('./registry').styles : value);
  (require || prop === 'V1Styles') && (exports.V1Styles = V1Styles = require ? require('./v1').V1Styles : value);
};
