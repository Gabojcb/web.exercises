System.register(["@beyond-js/kernel/bundle", "@beyond-js/backend/client", "@beyond-js/kernel/core", "socket.io-client"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, dependency_2, dependency_3, __Bundle, __pkg, ims, local, __beyond_pkg, hmr;
  _export("local", void 0);
  return {
    setters: [function (_beyondJsKernelBundle) {
      dependency_0 = _beyondJsKernelBundle;
    }, function (_beyondJsBackendClient) {
      dependency_1 = _beyondJsBackendClient;
    }, function (_beyondJsKernelCore) {
      dependency_2 = _beyondJsKernelCore;
    }, function (_socketIoClient) {
      dependency_3 = _socketIoClient;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
      ...
      ***********************/
      ...
      __pkg.exports.process = function ({
        ...
        (require || prop === 'local') && _export("local", local = require ? require('./local').local : value);
      };
