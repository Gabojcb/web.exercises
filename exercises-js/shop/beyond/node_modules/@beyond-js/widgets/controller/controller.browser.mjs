...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.3/controller"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./client', {hash: 97446879, creator: function (require, exports) {
"use strict";
