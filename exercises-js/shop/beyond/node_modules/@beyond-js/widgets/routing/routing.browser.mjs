...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.3/routing"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./layouts/index', {hash: 2940970575, creator: function (require, exports) {
"use strict";
...
ims.set('./layouts/layout', {hash: 2602064878, creator: function (require, exports) {
"use strict";
...
/*bundle*/class Layout extends _core.Events {
  get is() {
    return 'layout';
  }
  #layouts;
...
ims.set('./manager', {hash: 1504779151, creator: function (require, exports) {
"use strict";
...
/*bundle*/const manager = typeof process === 'object' ? void 0 : new class Manager {
...
ims.set('./pages/index', {hash: 635174642, creator: function (require, exports) {
"use strict";
...
ims.set('./pages/instance', {hash: 2192565275, creator: function (require, exports) {
"use strict";
...
ims.set('./route', {hash: 408835594, creator: function (require, exports) {
"use strict";
...
ims.set('./uri', {hash: 615392904, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./layouts/layout","from":"Layout","name":"Layout"},{"im":"./manager","from":"manager","name":"manager"},{"im":"./pages/instance","from":"PageInstance","name":"PageInstance"},{"im":"./route","from":"Route","name":"Route"},{"im":"./uri","from":"PageURI","name":"PageURI"}];

export let Layout, manager, PageInstance, Route, PageURI;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'Layout') && (Layout = require ? require('./layouts/layout').Layout : value);
    (require || prop === 'manager') && (manager = require ? require('./manager').manager : value);
    (require || prop === 'PageInstance') && (PageInstance = require ? require('./pages/instance').PageInstance : value);
    (require || prop === 'Route') && (Route = require ? require('./route').Route : value);
    (require || prop === 'PageURI') && (PageURI = require ? require('./uri').PageURI : value);
...
//# sourceMappingURL=routing.browser.mjs.map