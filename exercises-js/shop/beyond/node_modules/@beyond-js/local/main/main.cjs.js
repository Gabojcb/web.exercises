...
exports.local = exports.hmr = exports.__beyond_pkg = void 0;
...
var dependency_3 = require("socket.io-client");
const {
  Bundle: __Bundle
} = dependency_0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'local') && (exports.local = local = require ? require('./local').local : value);
};
