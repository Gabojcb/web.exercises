...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.4/layout"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./children', {hash: 1491145116, creator: function (require, exports) {
"use strict";
...
ims.set('./ssr', {hash: 2390596202, creator: function (require, exports) {
"use strict";
...
exports.ssr = void 0;
/*bundle*/const ssr = new class extends EventTarget {
  // The main layout
  #main;
  get main() {
    return this.#main;
...
__pkg.exports.descriptor = [{"im":"./ssr","from":"ssr","name":"ssr"}];

export let ssr;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'ssr') && (ssr = require ? require('./ssr').ssr : value);
...
//# sourceMappingURL=layout.browser.mjs.map