...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/kernel@0.1.9/transversals"},"type":"ts"}, import.meta.url).package();;
...
//# sourceMappingURL=transversals.browser.mjs.map