...
__pkg.exports.process = function ({
  ...
  (require || prop === 'CurrentTexts') && (exports.CurrentTexts = CurrentTexts = require ? require('./current').CurrentTexts : value);
  (require || prop === 'Texts') && (exports.Texts = Texts = require ? require('./texts').Texts : value);
};
