...
exports.manager = exports.hmr = exports.__beyond_pkg = exports.Route = exports.PageURI = exports.PageInstance = exports.Layout = void 0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'Layout') && (exports.Layout = Layout = require ? require('./layouts/layout').Layout : value);
  (require || prop === 'manager') && (exports.manager = manager = require ? require('./manager').manager : value);
  (require || prop === 'PageInstance') && (exports.PageInstance = PageInstance = require ? require('./pages/instance').PageInstance : value);
  (require || prop === 'Route') && (exports.Route = Route = require ? require('./route').Route : value);
  (require || prop === 'PageURI') && (exports.PageURI = PageURI = require ? require('./uri').PageURI : value);
};
