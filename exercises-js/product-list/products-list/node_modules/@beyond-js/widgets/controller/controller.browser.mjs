...
import * as dependency_2 from '@beyond-js/widgets/render';
import * as dependency_3 from '@beyond-js/kernel/styles';

const {Bundle: __Bundle} = dependency_0;
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/widgets@0.1.4/controller"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./attributes', {hash: 3176328789, creator: function (require, exports) {
"use strict";
...
/*bundle*/class WidgetAttributes extends Map {
...
ims.set('./client', {hash: 2102509577, creator: function (require, exports) {
"use strict";
...
ims.set('./controller', {hash: 4127212824, creator: function (require, exports) {
"use strict";
...
/*bundle*/class WidgetControllerBase {
  #specs;
  get specs() {
    return this.#specs;
  }
...
ims.set('./ssr', {hash: 1515978368, creator: function (require, exports) {
"use strict";
...
__pkg.exports.descriptor = [{"im":"./attributes","from":"WidgetAttributes","name":"WidgetAttributes"},{"im":"./client","from":"WidgetClientController","name":"WidgetClientController"},{"im":"./controller","from":"IWidgetStore","name":"IWidgetStore"},{"im":"./controller","from":"WidgetControllerBase","name":"WidgetControllerBase"},{"im":"./ssr","from":"IWidgetRendered","name":"IWidgetRendered"},{"im":"./ssr","from":"WidgetServerController","name":"WidgetServerController"}];

export let WidgetAttributes, WidgetClientController, IWidgetStore, WidgetControllerBase, IWidgetRendered, WidgetServerController;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'WidgetAttributes') && (WidgetAttributes = require ? require('./attributes').WidgetAttributes : value);
    (require || prop === 'WidgetClientController') && (WidgetClientController = require ? require('./client').WidgetClientController : value);
    (require || prop === 'IWidgetStore') && (IWidgetStore = require ? require('./controller').IWidgetStore : value);
    (require || prop === 'WidgetControllerBase') && (WidgetControllerBase = require ? require('./controller').WidgetControllerBase : value);
    (require || prop === 'IWidgetRendered') && (IWidgetRendered = require ? require('./ssr').IWidgetRendered : value);
    (require || prop === 'WidgetServerController') && (WidgetServerController = require ? require('./ssr').WidgetServerController : value);
...
//# sourceMappingURL=controller.browser.mjs.map