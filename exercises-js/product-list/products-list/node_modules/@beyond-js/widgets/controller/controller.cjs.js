...
exports.hmr = exports.__beyond_pkg = exports.WidgetServerController = exports.WidgetControllerBase = exports.WidgetClientController = exports.WidgetAttributes = exports.IWidgetStore = exports.IWidgetRendered = void 0;
...
var dependency_3 = require("@beyond-js/kernel/styles");
const {
  Bundle: __Bundle
} = dependency_0;
...
__pkg.exports.process = function ({
  ...
  (require || prop === 'WidgetAttributes') && (exports.WidgetAttributes = WidgetAttributes = require ? require('./attributes').WidgetAttributes : value);
  (require || prop === 'WidgetClientController') && (exports.WidgetClientController = WidgetClientController = require ? require('./client').WidgetClientController : value);
  (require || prop === 'IWidgetStore') && (exports.IWidgetStore = IWidgetStore = require ? require('./controller').IWidgetStore : value);
  (require || prop === 'WidgetControllerBase') && (exports.WidgetControllerBase = WidgetControllerBase = require ? require('./controller').WidgetControllerBase : value);
  (require || prop === 'IWidgetRendered') && (exports.IWidgetRendered = IWidgetRendered = require ? require('./ssr').IWidgetRendered : value);
  (require || prop === 'WidgetServerController') && (exports.WidgetServerController = WidgetServerController = require ? require('./ssr').WidgetServerController : value);
};
