System.register(["@beyond-js/kernel/bundle", "@beyond-js/widgets/render"], function (_export, _context) {
  "use strict";

  var dependency_0, dependency_1, __Bundle, __pkg, ims, ssr, __beyond_pkg, hmr;
  _export("ssr", void 0);
  return {
    setters: [function (_beyondJsKernelBundle) {
      dependency_0 = _beyondJsKernelBundle;
    }, function (_beyondJsWidgetsRender) {
      dependency_1 = _beyondJsWidgetsRender;
    }],
    execute: function () {
      ({
        Bundle: __Bundle
...
//# sourceMappingURL=layout.sjs.js.map