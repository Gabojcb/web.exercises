...
const __pkg = new __Bundle({"module":{"vspecifier":"@beyond-js/kernel@0.1.9/styles"},"type":"ts"}, import.meta.url).package();;
...
ims.set('./dependencies-styles', {hash: 282408023, creator: function (require, exports) {
"use strict";
...
/*bundle*/class DependenciesStyles extends _core.Events {
  #vspecifier;
  #elements;
  get elements() {
...
ims.set('./legacy', {hash: 859564821, creator: function (require, exports) {
"use strict";
...
ims.set('./registry', {hash: 2402124624, creator: function (require, exports) {
"use strict";
...
/*bundle*/const styles = new Registry();
...
ims.set('./v1', {hash: 1891964101, creator: function (require, exports) {
"use strict";
...
var _core = require("@beyond-js/kernel/core");
var _bundle = require("@beyond-js/kernel/bundle");
/*bundle*/class V1Styles extends _core.Events {
  get engine() {
    return 'v1';
  }
  /**
...
__pkg.exports.descriptor = [{"im":"./dependencies-styles","from":"DependenciesStyles","name":"DependenciesStyles"},{"im":"./registry","from":"styles","name":"styles"},{"im":"./v1","from":"V1Styles","name":"V1Styles"}];

export let DependenciesStyles, styles, V1Styles;

// Module exports
__pkg.exports.process = function({require, prop, value}) {
    (require || prop === 'DependenciesStyles') && (DependenciesStyles = require ? require('./dependencies-styles').DependenciesStyles : value);
    (require || prop === 'styles') && (styles = require ? require('./registry').styles : value);
    (require || prop === 'V1Styles') && (V1Styles = require ? require('./v1').V1Styles : value);
...
//# sourceMappingURL=styles.browser.mjs.map